...
namespace FileIOoperation.FileIO
{
    class FileReadWriteOperation
    {
        ...
        { 
            ...
            string destination = @"H:\visualstudio\FileIOoperation\FileIOoperation\FileIO\Sample1.txt";
            try
            {
        ...
        {
            string streamWritePath = @"H:\visualstudio\FileIOoperation\FileIOoperation\FileIO\SampleStreamWrite.txt";
            ...
            try
            {
                ...
                {
                    writer.WriteLine("Love for Dot Net");
                }
            }
            catch (Exception ex)
            {
